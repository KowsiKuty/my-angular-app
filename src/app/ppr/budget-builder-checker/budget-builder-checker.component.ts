...
@Component({
  selector: 'app-budget-builder-checker',
  templateUrl: './budget-builder-checker.component.html',
  styleUrls: ['./budget-builder-checker.component.scss']
})
export class BudgetBuilderCheckerComponent implements OnInit {
  ...
  branchname() {
    ...
    let finyearbranch = this.pprSearchForm.controls["finyear"].value
    this.branchFinyear = finyearbranch.finyer
    this.pprSearchForm.get('branchid').valueChanges
      .pipe(
        ...
        switchMap(value => this.dataService.getpprbranchdropdownyear(value, 1, this.branchFinyear)
          .pipe(
            finalize(() => {
              this.isLoading = false
  ...
  private getbranchid(prokeyvalue) {
    let finyearbranchs = this.pprSearchForm.controls["finyear"].value
    this.branchFinyears = finyearbranchs.finyer
    this.dataService.getpprbranchdropdownyear(prokeyvalue, 1, this.branchFinyears)
      .subscribe((results: any[]) => {
        let datas = results["data"];
        this.branchList = datas;
          ...
          .subscribe(() => {
            ...
            if (atBottom) {
              if (this.has_nextbra === true) {
                this.dataService.getpprbranchdropdownyear(this.branchContactInput.nativeElement.value, this.currentpagebra + 1, this.branchFinyear)
                  .subscribe((results: any[]) => {
                    let datas = results["data"];
                    let datapagination = results["pagination"];
  ...
  Business_dropdown() {
    let prokeyvalue: String = "";
    let finyearbusiness = this.pprSearchForm.controls["finyear"].value
    this.businessFinyear = finyearbusiness.finyer
    ...
    this.pprSearchForm.get('businesscontrol').valueChanges
      .pipe(
        ...
        switchMap(value => this.dataService.getbusinessbudgetdropdownyear(this.sector_id, this.branchid, this.branchcode, value, 1, this.businessFinyear)
          .pipe(
            finalize(() => {
              this.isLoading = false
            }),
  ...
  private getbusiness(prokeyvalue) {
    let finyearbusinesss = this.pprSearchForm.controls["finyear"].value
    this.businessFinyears = finyearbusinesss.finyer
    this.dataService.getbusinessbudgetdropdownyear(this.sector_id, this.branchid, this.branchcode, prokeyvalue, 1, this.businessFinyears)
      .subscribe((results: any[]) => {
        let datas = results["data"];
        this.businessList = datas;
      ...
      if (
        ...
        fromEvent(this.business_name.panel.nativeElement, 'scroll')
          ...
          .subscribe(() => {
            ...
            if (atBottom) {
              if (this.has_nextbra === true) {
                this.dataService.getbusinessbudgetdropdownyear(this.sector_id, this.branchid, this.branchcode, this.businessInput.nativeElement.value, this.currentpagebra + 1, this.businessFinyears)
                  .subscribe((results: any[]) => {
                    let datas = results["data"];
                    let datapagination = results["pagination"];
  ...
  bsname_dropdown() {
    ...
    let finyearbs = this.pprSearchForm.controls["finyear"].value
    this.BsFinyear = finyearbs.finyer
    this.pprSearchForm.get('bs_id').valueChanges
      .pipe(
        ...
        switchMap(value => this.dataService.getbsbudgetdropdownyear(this.business_id, this.branchid, this.branchcode, value, 1, this.BsFinyear )
          .pipe(
            finalize(() => {
              this.isLoading = false
            }),
  ...
  private getbsid(prokeyvalue) {
    let finyearbss = this.pprSearchForm.controls["finyear"].value
    this.BsFinyears = finyearbss.finyer
    this.dataService.getbsbudgetdropdownyear(this.business_id, this.branchid, this.branchcode, prokeyvalue, 1, this.BsFinyears)
      .subscribe((results: any[]) => {
        let datas = results["data"];
        this.bsList = datas;
          ...
          .subscribe(() => {
            ...
            if (atBottom) {
              if (this.has_nextbs === true) {
                this.dataService.getbsbudgetdropdownyear(this.business_id, this.branchid, this.branchcode, this.bsInput.nativeElement.value, this.currentpagebs + 1, this.BsFinyears)
                  .subscribe((results: any[]) => {
                    let datas = results["data"];
                    let datapagination = results["pagination"];
  ...
  budgetbuildersearech_click(data) {
    ...
    if ((data.bs_id == undefined) || (data.bs_id == '')) {
      ...
      this.pprSearchForm.value.bsid = this.pprSearchForm.value.bs_id.id
    }
    if ((data.cc_id == undefined) || (data.cc_id == '')) {
      ...
      this.pprSearchForm.value.ccid = this.pprSearchForm.value.cc_id.id
    }
    ...
    this.searchDatas = {
      ...
      "bs_id":this.pprSearchForm.value.bsid,
      "cc_id":this.pprSearchForm.value.ccid,
    ...
    this.dataService.getbudgetcheckersummary(this.searchDatas)
      .subscribe((results: any[]) => {
  ...
  private new_expense_list(ind, data, data1, pageNumber, mon_type) {
    ...
    this.dataService.new_builderexpense_checker_list(data)
      .subscribe((results: any[]) => {
        this.SpinnerService.hide()
  ...
  private new_buildercat_list(ind, data, data1, mon_type) {
    ...
    this.dataService.new_buildercat_checker_list(data)
      .subscribe((results: any[]) => {
        this.SpinnerService.hide()
  ...
  private new_buildersubcat_list(ind, data, data1, mon_type) {
    ...
    this.dataService.new_buildersubcat_checker_list(data)
      .subscribe((results: any[]) => {
        this.SpinnerService.hide()
  ...
  private getsupplieramountdetails(ind, data, data1, mon_type) {
    ...
    this.dataService.budgetchecker_getsupplieramountdetails(data)
      .subscribe((results: any[]) => {
        this.SpinnerService.hide()
  ...
  budget_status_set(status,status_value){
  ...
  let remark=this.approverForm.value.remarks
    this.SpinnerService.show()
    this.dataService.budget_status_set(status,params_data,status_value,remark)
      .subscribe((results: any[]) => {
        this.SpinnerService.hide()
        ...
        if(results['message']=='CREATED SUCCESS'){
          if(status==3){
            this.toastr.success('', 'Move To Approver', { timeOut: 1500 });
            this.closebutton.nativeElement.click();
            return false;
          } if(status==6){
  ...
  excel_download(){
    console.log('ppr',this.pprSearchForm.value)
    var excel=this.pprSearchForm.value
    var fin_year
    var year_term
    var div_amount
    var sector_name
    ...
    var cc
    var flag
    if( excel.finyear == '' ||  excel.finyear == null || excel.finyear == undefined){
      this.toastr.warning('','Please Select The FinYear',{timeOut:1500});
      return false;
    }else{
      if((typeof excel.finyear == 'object')){
        fin_year=excel.finyear.finyer;
      }if(typeof excel.finyear == 'string'){
        fin_year=excel.finyear
      }
     
    }
    if(typeof excel.year_term != 'string'){
      this.toastr.warning('','Please Select The Year Term',{timeOut:1500});
      return false;
    }else{
      year_term=excel.year_term
    }
    if(typeof excel.divAmount != 'string'){
      this.toastr.warning('','Please Select The Div Amount',{timeOut:1500});
      return false;
    }else{
      div_amount=excel.divAmount
    }
    if(excel.flag==undefined || excel.flag == null){
      this.toastr.warning('', 'Please Select ALEI', { timeOut: 1500 });
      return false;
      flag=''
    }else if(excel.flag== ''){
      ...
      flag=typeof excel.flag=="object"?excel.flag.flag :excel.flag
    }
    if(typeof excel.branchid != 'object'){
      this.toastr.warning('','Please Select The Branch',{timeOut:1500});
      return false;
    }else{
      branch=excel.branchid.id
    }
    if(( excel.sectorname == null) || ( excel.sectorname == undefined) || (excel.sectorname =='')){
      this.toastr.warning('','Please Select The Sector',{timeOut:1500});
      return false;
    }else{
      if(typeof excel.sectorname == 'object'){
        sector_name=excel.sectorname.name
      }if(typeof excel.sectorname == 'string'){
        sector_name=excel.sectorname
      }
    }
    if(typeof excel.businesscontrol != 'object'){
      this.toastr.warning('','Please Select The Business',{timeOut:1500});
      return false;
    }else if(excel.businesscontrol ==null){
      this.toastr.warning('','Please Select The Business',{timeOut:1500});
      return false;
    }else{
      business=excel.businesscontrol
    }
    if(typeof excel.bs_id != 'object'){
      this.toastr.warning('','Please Select The Business Segment',{timeOut:1500});
      return false;
    }else if( excel.bs_id == null){
      this.toastr.warning('','Please Select The Business Segment',{timeOut:1500});
      return false;
    }else{
      bs=excel.bs_id
    }
    if(typeof excel.cc_id != 'object'){
      this.toastr.warning('','Please Select The Cost Center',{timeOut:1500});
      return false;
    }else if(typeof excel.cc_id != 'object'){
      this.toastr.warning('','Please Select The Cost Center',{timeOut:1500});
      return false;
    }else{
      cc=excel.cc_id
    ...
    let exceldownload = {
      ...
      "masterbusinesssegment_name":business.name,
      "bs_name":bs.name,
      "cc_name":cc.name,
      "branch_id":branch,
      "pagequery":"CHECKER",
    ...
    this.dataService.budget_download(exceldownload).subscribe((data:any) => { 
      this.SpinnerService.hide();
  ...
  budget_builder_xlsx(){
    ...
    XLSX.utils.book_append_sheet(new_workbook, variance_table, 'Budget Checker');
    XLSX.writeFile(new_workbook, "Budget Checker.xlsx");
  }
}
