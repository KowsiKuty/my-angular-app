...
export class BudgetBuilderApproveComponent implements OnInit {
  ...
  currentpage: number;
  pprname: any;
  searchDatas: {bs_id:any; cc_id:any;business_id:any; finyear: any; year_term: any; sectorname: any; divAmount: any; masterbusinesssegment_name: any; bs_name: any; cc_name: any; status_id: any; branch_id: any; expensegrp_name_arr: any;alei_flag:any; microbscode:any;microcccode:any};
  businessFinyear: any;
  bsFinyear: any;
  branchFinyear: any;
  branchFinyears: any;
          ...
          .subscribe(() => {
            ...
            if (atBottom) {
              if (this.has_nextbra === true) {
                this.dataService.getpprbranchdropdownyear(this.branchContactInput.nativeElement.value, this.currentpagebra + 1, this.branchFinyears)
                  .subscribe((results: any[]) => {
                    let datas = results["data"];
                    let datapagination = results["pagination"];
  ...
  Business_dropdown() {
    ...
    let finyearbusinee = this.pprSearchForm.controls["finyear"].value
    this.businessFinyear = finyearbusinee.finyer
  ...
  private getbusiness(prokeyvalue) {
    let finyearbusinees = this.pprSearchForm.controls["finyear"].value
    this.businessFinyears = finyearbusinees.finyer
  ...
  private getbsid(prokeyvalue) {
    this.dataService.getbsbudgetdropdownyear(this.business_id, this.branchid, this.branchcode, prokeyvalue, 1, this.bsFinyear)
      .subscribe((results: any[]) => {
        let datas = results["data"];
        this.bsList = datas;
          ...
          .subscribe(() => {
            ...
            if (atBottom) {
              if (this.has_nextbs === true) {
                this.dataService.getbsbudgetdropdownyear(this.business_id, this.branchid, this.branchcode, this.bsInput.nativeElement.value, this.currentpagebs + 1, this.bsFinyear)
                  .subscribe((results: any[]) => {
                    let datas = results["data"];
                    let datapagination = results["pagination"];
  ...
  excel_download(){
    ...
    this.dataService.budget_download(exceldownload).subscribe((data:any) => { 
      ...
      link.click();
      this.toastr.success('Success Download');
      }, error => {
      this.errorHandler.handleError(error);
      this.SpinnerService.hide();
    })
  ...
  budget_builder_xlsx(){
    ...
    XLSX.utils.book_append_sheet(new_workbook, variance_table, 'Budget Approver');
    XLSX.writeFile(new_workbook, "Budget Approver.xlsx");
  }
}
