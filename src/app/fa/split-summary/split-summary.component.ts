...
export class SplitSummaryComponent implements OnInit {
  ...
  Download_prepare(){
    ...
    this.first=true;
    this.spinner.show();
    searchSplit['from_date']=this.datePipe.transform(this.SplitSearchForm.get('fromdate').value,'yyyy-MM-dd');
    searchSplit['to_date']=this.datePipe.transform(this.SplitSearchForm.get('todate').value,'yyyy-MM-dd');
  ...
  download_file(){
    ...
    this.spinner.show();
    this.Faservice.split_maker_downloadfile().subscribe(
      (response: any) =>{
        this.spinner.hide();
          // this.first=false;
          // this.first=false;
          if (response['type']=='application/json'){
            ...
            this.notification.showSuccess('Sucessfully downloaded');
            downloadLink.click();
           }
