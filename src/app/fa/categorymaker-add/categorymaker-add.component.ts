...
@Component({
  selector: 'app-categorymaker-add',
  templateUrl: './categorymaker-add.component.html',
  styleUrls: ['./categorymaker-add.component.scss']
})
export class CategorymakerAddComponent implements OnInit {
