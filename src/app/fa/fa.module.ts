...
import { FaReportsComponent } from './fa-reports/fa-reports.component';
import { FaAccRepostComponent } from './fa-acc-repost/fa-acc-repost.component';
import { AssetmakeModelComponent } from './assetmake-model/assetmake-model.component';
import { AssetspecificationComponent } from './assetspecification/assetspecification.component';
import { GeneralqueryComponent } from './generalquery/generalquery.component';
import { FaDbmanageComponent } from './fa-dbmanage/fa-dbmanage.component';
import { FaActiveInactiveComponent } from './fa-active-inactive/fa-active-inactive.component';
...
@NgModule({
  ...
  declarations: [AssetCategoryCreateComponent, FaMasterComponent, FaTransactionSummaryComponent,
    ...
    CategorychangeapproveComponent,CategorychangesummaryComponent,CategorychangesummaryaddComponent, CpdatechangeMakerSummaryComponent, CpDatechangeCheckerComponent, FaDepreciationCalComponent, BucketSummaryComponent, BucketSummaryViewComponent, FaReportsComponent, FaAccRepostComponent, AssetmakeModelComponent, AssetspecificationComponent, GeneralqueryComponent, FaDbmanageComponent, FaActiveInactiveComponent
  ],
  imports: [
    ToastrModule.forRoot({ timeOut: 10000 }),MatProgressBarModule,
