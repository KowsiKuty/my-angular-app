...
export class Fa3Service {
  ...
  public fetch_assettransfer(pageNumber = 1, pageSize = 10,search): Observable<any> {
    ...
    return this.http.post<any>(atmaUrl + 'faserv/fetch_assettransfer?page=' +pageNumber+"&pageSize="+pageSize,search,{ 'headers': headers })
  }
  ...
  public getbusinesssegmentfilter(name,pageno): Observable<any> {
    ...
    return this.http.get<any>(atmaUrl + 'usrserv/businesssegmentsearch?page=' + pageno + '&name=' + name + '&no=' + no, { 'headers': headers })
  }
  ...
  public getcostcentrefilter(bsid,name): Observable<any> {
    ...
    return this.http.get<any>(atmaUrl + 'usrserv/searchbs_cc?bs_id=' + bsid + '&query=' + name, { 'headers': headers })
  }
  ...
  public assettranfer(vendor: any, reason,date): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
  ...
  public assettranfersummary(pageNumber = 1, pageSize = 10,search): Observable<any> {
    ...
    return this.http.post<any>(atmaUrl + 'faserv/get_assettransferchecker?page='+pageNumber+"&pagesize="+pageSize,search,{ 'headers': headers })
  }
  ...
  public getHSNSearchFilter(hsnval,pageno,status ): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'mstserv/hsnsummary?code=' + hsnval + '&page=' + pageno + '&status=' + status, { 'headers': headers })
  }
  ...
  public getCheckerChangeApproveSummary(pageNumber = 1, pageSize = 10,search): Observable<any> {
    ...
    return this.http.post<any>(atmaUrl + 'faserv/get_catchangechecker?page='+pageNumber,search,{ 'headers': headers })
  }
  ...
  public assetsalesadd(pageNumber = 1, pageSize = 10,search): Observable<any> {
    ...
    return this.http.post<any>(atmaUrl + 'faserv/get_assetsale?page='+pageNumber+"&pageSize="+pageSize,search,{ 'headers': headers })
  }
  public assetchange(salesValue: any, reason,date,customerid,salerate,subcat): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
  ...
  public assetsalesapprove(pageNumber = 1, pageSize = 10,search): Observable<any> {
    ...
    return this.http.post<any>(atmaUrl + 'faserv/get_assetsalechecker?page='+pageNumber+"&pagesize="+pageSize , search,{ 'headers': headers })
  }
  ...
  public valuchange_download_prepare(body): Observable<any> {
    this.reset();
    const getToken: any = localStorage.getItem('sessionData');
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token;
    const headers = { 'Authorization': 'Token ' + token };
    return this.http.post<any>(atmaUrl + "faserv/asset_valuechangemaker_download_excelprepare",body, { headers: headers })
  }     
  public valuechange_downloadfile(){
    const getToken = localStorage.getItem('sessionData');
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token;
    const headers = { 'Authorization': 'Token ' + token };
    return this.http.post(atmaUrl + "faserv/assetvaluechangemaker_download_file" ,{}, { 'headers': headers,responseType: 'blob' as 'json' })
  }
  public trnsfr_download_prepare(body): Observable<any> {
    this.reset();
    const getToken: any = localStorage.getItem('sessionData');
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token;
    const headers = { 'Authorization': 'Token ' + token };
    return this.http.post<any>(atmaUrl + "faserv/transfermaker_download_excelprepare",body, { headers: headers })
  }     
  public trnsfr_downloadfile(){
    const getToken = localStorage.getItem('sessionData');
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token;
    const headers = { 'Authorization': 'Token ' + token };
    return this.http.post(atmaUrl + "faserv/transfermaker_download_file" ,{}, { 'headers': headers,responseType: 'blob' as 'json' })
  }
}