...
export class AssetCategoryCreateComponent implements OnInit {
  ...
  Subcatid: number = 0;
  isLoading = false;
  mgmt_dpdt_gl_subcat_id:any;
  mgmt_dpdt_reserve_gl_subcat_id:any;
  ...
  depgl_mgmt(data){
    ...
    // this.mgmt_dpdt_gl_subcat_id=data.id
  }
  depresgl_mgmt(data) {
  ...
  // this.mgmt_dpdt_reserve_gl_subcat_id=data.id
}
  assetcatCreateForm() {
    ...
    // this.assetcatform.value.depgl_mgmt=this.mgmt_dpdt_gl_subcat_id
    // this.assetcatform.value.depresgl_mgmt=this.mgmt_dpdt_reserve_gl_subcat_id  
