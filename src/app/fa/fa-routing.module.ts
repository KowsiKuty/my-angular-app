...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path:'fareport' , component:FaReportsComponent},
      { path:'farepostentry' , component:FaAccRepostComponent},
      {path:'fageneralquery',component:GeneralqueryComponent},
      {path:'fadb',component:FaDbmanageComponent},
      {path:'assetactive_inactive',component:FaActiveInactiveComponent}
    ]
  }
];
