...
export class ShareService {
  ...
  public vendorView = new BehaviorSubject<any>(' ');
  ...
  public catlogView = new BehaviorSubject<string>(' ');
  public vendorViewHeaderName = new BehaviorSubject<any>(' ');
  ...
  public modification_data=new BehaviorSubject<any>('')
  ...
  public activitydesignationedit= new BehaviorSubject<any>('');
  public activeordeact = new BehaviorSubject<any>('');
  public vendorsingleget=new BehaviorSubject<any>('');
  public portaluserdata = new BehaviorSubject<any>('');
  public activtycounts = new BehaviorSubject<any>('');
  public supplierdetails = new BehaviorSubject<any>('');
  public supplen = new BehaviorSubject<any>('');
  public ishighrisk = new BehaviorSubject<any>('');
