...
export class HsnEditComponent implements OnInit {
  ...
  rateid:any;
  constructor(private shateservice:ShareService,private fb:FormBuilder,private Notification:NotificationService,private atmaservice:AtmaService,private spinner:NgxSpinnerService) { }
