...
export class ProductEditComponent implements OnInit {
  ...
  type: any ={ label: "Account Type", fronentdata: true, data: this.typeList, "displaykey": "name", Outputkey: "value", valuekey: "value", required: true,formcontrolname: 'type',formkey:'value',};
  ...
  getProductEdit() {
    ...
    this.client1_id = dataa.client1_id.id
    this.client2_id = dataa.client2_id.id
    this.customer1_id = dataa.customer1_id.id
    this.customer2_id = dataa.customer2_id.id
    this.atmaService.get_singleproduct(this.vendorId, this.productEditId)
      .subscribe(result => {
        ...
        // this.type = { label: "Account Type", fronentdata: true, data: this.typeList, "displaykey": "name", Outputkey: "value", valuekey: "value", defaultvalue: this.Type, required: true,}
        console.log("this.type", this.type)
        ...
        // this.designationfield1prodedit1 = { label: "Designation", "method": "get", "url": this.atmaUrl + "mstserv/designation_search", params: "", "searchkey": "query", "displaykey": "name", defaultvalue: d1 , required: true,}
        ...
        // this.designationfield1prodedit1 = { label: "Designation", "method": "get", "url": this.atmaUrl + "mstserv/designation_search", params: "", "searchkey": "query", "displaykey": "name", defaultvalue: d2 , required: true,}
        /*Customer1*/
        ...
        // this.designationfield1prodedit2 = { label: "Designation", "method": "get", "url": this.atmaUrl + "mstserv/designation_search", params: "", "searchkey": "query", "displaykey": "name", wholedata: true, defaultvalue: d3, required: true,}
        /*Customer2*/
        ...
        // this.designationfield1prodedit2 = { label: "Designation", "method": "get", "url": this.atmaUrl + "mstserv/designation_search", params: "", "searchkey": "query", "displaykey": "name", wholedata: true, defaultvalue: d4, required: true,}
  ...
  productCreateForm() {
    ...
    var str  = this.productEditForm.value.client_contact1.id = this.client1_id
    ...
    var str  = this.productEditForm.value.client_contact2.id = this.client2_id
    ...
    var str  = this.productEditForm.value.customer_contact1.id = this.customer1_id
    ...
    var str  = this.productEditForm.value.customer_contact2.id = this.customer2_id
  ...
  //   })
  // }
  activitypesubmit(data) {

  }

  designationfield1prodedit1: any = { label: "Designation", "method": "get", "url": this.atmaUrl + "mstserv/designation_search", params: "", "searchkey": "query", "displaykey": "name", wholedata: true, required: true,
    formcontrolname: 'designation_id',
  }
  designationfield1prodedit2: any = { label: "Designation", "method": "get", "url": this.atmaUrl + "mstserv/designation_search", params: "", "searchkey": "query", "displaykey": "name", wholedata: true,required: true,
    formcontrolname: 'designation_id',
  }


  // designationprodedit1data(desgdata1) {
  //   this.productEditForm.controls.client_contact1.patchValue({
  //     designation_id: desgdata1
  //   })
  // }

  // designationprodedit2data(desgdata2) {
  //   this.productEditForm.controls.client_contact2.patchValue({
  //     designation_id: desgdata2
  //   })
  // }

  // designationprodedit3data(desgdata3) {
  //   this.productEditForm.controls.customer_contact1.patchValue({
  //     designation_id: desgdata3
  //   })
  // }

  // designationprodedit4data(desgdata4) {
  //   this.productEditForm.controls.customer_contact2.patchValue({
  //     designation_id: desgdata4
  //   })
  // }
}
