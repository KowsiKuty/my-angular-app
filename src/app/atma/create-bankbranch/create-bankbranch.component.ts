...
export class CreateBankbranchComponent implements OnInit {
  ...
  submitForm() {
    ...
    if(this.AddForm.get('bank_id').value.id==undefined || this.AddForm.get('bank_id').value=='' || this.AddForm.get('bank_id').value=="" || this.AddForm.get('bank_id').value==null){
      this.notification.showError('Please Select The Bank Name');
      return false;
    }
    ...
    if((this.AddForm.get('address_id') as FormGroup).get('pincode_id').value.id==undefined || (this.AddForm.get('address_id') as FormGroup).get('pincode_id').value=="" || (this.AddForm.get('address_id') as FormGroup).get('pincode_id').value=='' || (this.AddForm.get('address_id') as FormGroup).get('pincode_id').value==null){
      this.notification.showError('Please Select The Address Pincode');
      return false;
    }
    if((this.AddForm.get('address_id') as FormGroup).get('city_id').value.id==undefined || (this.AddForm.get('address_id') as FormGroup).get('city_id').value=="" || (this.AddForm.get('address_id') as FormGroup).get('city_id').value=='' || (this.AddForm.get('address_id') as FormGroup).get('city_id').value==null){
      this.notification.showError('Please Select The Address City');
      return false;
    }
    if((this.AddForm.get('address_id') as FormGroup).get('district_id').value.id==undefined || (this.AddForm.get('address_id') as FormGroup).get('district_id').value=="" || (this.AddForm.get('address_id') as FormGroup).get('district_id').value=='' || (this.AddForm.get('address_id') as FormGroup).get('district_id').value==null){
      this.notification.showError('Please Select The Address District');
      return false;
    }
    if((this.AddForm.get('address_id') as FormGroup).get('state_id').value.id==undefined || (this.AddForm.get('address_id') as FormGroup).get('state_id').value=="" || (this.AddForm.get('address_id') as FormGroup).get('state_id').value=='' || (this.AddForm.get('address_id') as FormGroup).get('state_id').value==null){
      this.notification.showError('Please Select The Address State');
      return false;
    }
