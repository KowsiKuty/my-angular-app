...
import { ActivitydesignationmasterComponent } from './activitydesignationmaster/activitydesignationmaster.component';
...
@NgModule({
  declarations: [VendorMasterComponent, TaxComponent, TaxEditComponent, SubTaxComponent,
    ...
    VendormodificationComponent, ConfirmnotificationComponent, ValidationserviceComponent, HsnComponent, HsnEditComponent, QuestionnaireComponent,
    QuestypemasterComponent,QuesheaderMasterComponent,QuestionmasterComponent,QuestionmappingComponent,DocumentQuestionerMappingComponent,
    EvaluationComponent,
    ActivitydesignationmasterComponent,ActivityQuestionnaireComponent,PortaluserComponent,PortaluserSummaryComponent,GroupformComponent
  ],
