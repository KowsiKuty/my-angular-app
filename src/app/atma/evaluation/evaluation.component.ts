...
export class EvaluationComponent implements OnInit {
  ...
  constructor(private activateroute: ActivatedRoute,private router: Router, private spinnerservice: NgxSpinnerService, private shareService: ShareService, private notification: NotificationService, private atmaService: AtmaService,
  ...
  questionsubmit(value, typestatus, renew) {
    ...
    let finalobj = {
      ...
      "period": 1,
      "period_start": this.datepipe.transform(moment(), "yyyy-MM-dd"),
      "period_end": this.datepipe.transform(moment(), "yyyy-MM-dd"),
      "remarks": '',
  ...
  getvendorviewrouting(){
    // this.router.navigate(['/atma/vendorView'],{ queryParams: {"vendorid": btoa(this.vendorid) }} )

  }

  sendquestionemail(){
    
    this.atmaService.sendquestionnairemail(this.vendorid).subscribe(
      result =>{
        console.log(result)
      })
  }
