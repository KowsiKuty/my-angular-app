...
export class ProductComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private atmaService: AtmaService,private errorHandler: ErrorHandlingService,private SpinnerService: NgxSpinnerService,
    ...
    private datePipe: DatePipe,private toastr: ToastrService ) { 
      ...
      this.type={label:"Type", fronentdata:true, data:this.typeList,params:"", "searchkey":"", "displaykey":"name", Outputkey:"value", required: true,
  ...
  client1Copy(data) {
    ...
    // this.designationfieldprod = {label:"Designation","method":"get","url":this.atmaUrl+"mstserv/designation_search",params:"","searchkey":"query","displaykey":"name",wholedata : true, defaultvalue:Designation, required: true, }
  ...
  customer1Copy(data) {
    ...
    let EMail = data.value.email;
    let Designation = datas.value.designation_id
    // this.designationfield1prod = {label:"Designation","method":"get","url":this.atmaUrl+"mstserv/designation_search",params:"","searchkey":"query","displaykey":"name",wholedata : true, defaultvalue:Designation ,required: true,}
    // let Type = datas.value.type_id;
    let landLine1 = datas.value.landline;
    let landLine2 = datas.value.landline2;
    let mobile1 = datas.value.mobile;
  ...
  //   }
    ...
    designationfieldprod:any = {label:"Designation","method":"get","url":this.atmaUrl+"mstserv/designation_search",params:"","searchkey":"query","displaykey":"name",wholedata : true, required: true,
      formcontrolname: 'designation_id', 
    }
    designationfield1prod:any = {label:"Designation","method":"get","url":this.atmaUrl+"mstserv/designation_search",params:"","searchkey":"query","displaykey":"name",wholedata : true, required: true,
      formcontrolname: 'designation_id', 
    }
    
//     designationproddata(desgdata){
// this.productForm.controls.client_contact1.patchValue({
//   designation_id:desgdata
// })
//     }

//   designationprod1data(desgdata1){
// this.productForm.controls.client_contact2.patchValue({
//   designation_id:desgdata1
// })
//   }

  designationprod2data(desgdata2){
    this.productForm.controls.customer_contact1.patchValue({
      designation_id:desgdata2
    })
  }
  designationprod3data(desgdata2){
    this.productForm.controls.customer_contact2.patchValue({
      designation_id:desgdata2
    })
  }
}
