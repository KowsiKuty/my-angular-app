...
currentpage: number = 1;
  ...
  editBranchForm() {
    ...
    if(this.bankbranchEditForm.get('bank_id').value.id==undefined || this.bankbranchEditForm.get('bank_id').value=='' || this.bankbranchEditForm.get('bank_id').value==null){
    ...
    if((this.bankbranchEditForm.get('address_id') as FormGroup).get('pincode_id').value.id==undefined || (this.bankbranchEditForm.get('address_id') as FormGroup).get('pincode_id').value=='' || (this.bankbranchEditForm.get('address_id') as FormGroup).get('pincode_id').value==null){
      this.notification.showError('Please Select The Address PinCode');
      return false;
    }
    if((this.bankbranchEditForm.get('address_id') as FormGroup).get('city_id').value.id==undefined || (this.bankbranchEditForm.get('address_id') as FormGroup).get('city_id').value=='' || (this.bankbranchEditForm.get('address_id') as FormGroup).get('city_id').value==null){
      this.notification.showError('Please Select The Address City');
      return false;
    }
    if((this.bankbranchEditForm.get('address_id') as FormGroup).get('district_id').value.id==undefined || (this.bankbranchEditForm.get('address_id') as FormGroup).get('district_id').value=='' || (this.bankbranchEditForm.get('address_id') as FormGroup).get('district_id').value==null){
      this.notification.showError('Please Select The Address District');
      return false;
    }
    if((this.bankbranchEditForm.get('address_id') as FormGroup).get('state_id').value.id==undefined || (this.bankbranchEditForm.get('address_id') as FormGroup).get('state_id').value=='' || (this.bankbranchEditForm.get('address_id') as FormGroup).get('state_id').value==null){
