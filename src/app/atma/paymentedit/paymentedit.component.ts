...
export class PaymenteditComponent implements OnInit {
  ...
  paymodefield:any =  {
    label: "Pay Mode",
    method: "get",
    url: this.vendorURL + "mstserv/paymode_search",
    params: "",
    searchkey: "query",
    displaykey: "name",
    wholedata: true,
    required: true,
    formcontrolname: 'paymode_id'
  };
  ifscfield:any ={
    label: "IFSC",
    method: "get",
    url: this.vendorURL + "mstserv/ifsc?bank_id="+this.branchrefid,
    params: "",
    searchkey: "query",
    displaykey: "ifsccode",
    wholedata: true,
  ...
  constructor(private fb: FormBuilder,private shareService: ShareService,
    ...
    private toastr: ToastrService) {
      this.accountype={label:"Account Type", fronentdata:true, data:this.accTypeList, "displaykey":"name", Outputkey:"value", valuekey:"value", required: true}
  ...
  branchPaymentCreate() {
    ...
    //  if(this.branchPayment.value.bankname=="CITIBANK NA"){
    //   if(this.branchPayment.value.account_no.length>20){
    //     this.toastr.error('Account No Must be 20 digits  ');
    //   this.SpinnerService.hide();
    //   return false;
    //   }
    // }
    ...
    // if(this.branchPayment.value.bankname!='CITIBANK NA'){
    //   if(this.branchPayment.value.account_no.length>18){
    //     this.toastr.error('Account No Must be 18 digits  ');
    //   this.SpinnerService.hide();
    //   return false;}
    // }
...
//   }
  ...
  branchdetails() {
   ...
   this.accountype={label:"Account Type", fronentdata:true, data:this.accTypeList, "displaykey":"name", Outputkey:"value", valuekey:"value",defaultvalue:this.Type, required: true}
   console.log("this.accountype======", this.accountype)
  //  this.paymodefield = {
  //   label: "Pay Mode",
  //   method: "get",
  //   url: this.vendorURL + "mstserv/paymode_search",
...
paymodetype(event){
  ...
  ifscdata(e) {
    console.log("ifscdata ====> ", e);
    // this.bank_name = e.bank.name
    ...
    // });
        ...
        if(e == undefined || e == "" || e == null)
          ...
          this.SpinnerService.show();
          this.branchPayment.get('bank_id').setValue(e.bank)
            this.branchPayment.get('bankname').setValue(e?.bank?.name)
            this.branchPayment.get('bname').setValue(e.name)
            this.SpinnerService.hide();
            if(this.branchPayment.value.bankname=="KARUR VYSYA BANK"){
              this.maxlength=16
            }else{
