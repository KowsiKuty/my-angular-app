...
export class BranchPaymentComponent implements OnInit {
  ...
  branch_name: any;
  ifscvar: any;
  constructor(private fb: FormBuilder,private shareService: ShareService,private router:Router,
    ...
    private toastr: ToastrService) {
      this.accountype={ label: "Account Type", fronentdata: true, data: this.accTypeList, params: "", "searchkey": "", "displaykey": "name", Outputkey: "value", required: true}
      this.paymodefield = {
        label: "Pay Mode",
        method: "get",
...
this.paymode_ddflag=false;
  ...
  branchPaymentCreate() {
    ...
    this.atmaService.branchPayMentCreate(this.branchPayment.value, this.mainbid)
      .subscribe(res => {
