...
export class ClientEditComponent implements OnInit {
  ...
  isLoading = false;
  stateID = 0;
  pincodeeditfield:any={label: "Pin Code",
    method: "get",
  ...
  districteditfield:any={label: "District",
    method: "get",
  ...
  getClientEdit() {
    ...
    let pincodes= data.address_id.pincode_id
        pincodes.city = data.address_id.city_id
        pincodes.district= data.address_id.district_id
        pincodes.state = data.address_id.state_id
        // this.pincodeeditfield = {
        //   label: "Pin Code",
        //   method: "get",
        //   url: this.atmaUrl + "mstserv/pincode_search",
  ...
  clientEditForm_() {
    ...
    if (this.clientEditForm.value.address.pincode_id.city.id === undefined || this.clientEditForm.value.address.pincode_id.city === "") {
      this.toastr.error('Please Select Valid city');
      this.SpinnerService.hide();
      return false;
    }
    if (this.clientEditForm.value.address.pincode_id.district.id === undefined || this.clientEditForm.value.address.pincode_id.district === "") {
      this.toastr.error('Please Select Valid district');
      this.SpinnerService.hide();
      return false;
    }
    if (this.clientEditForm.value.address.pincode_id.state.id === undefined || this.clientEditForm.value.address.pincode_id.state === "") {
    ...
    this.clientEditForm.controls.address.value.city_id = this.clientEditForm.controls.address.value.pincode_id.city.id;
    this.clientEditForm.controls.address.value.district_id = this.clientEditForm.controls.address.value.pincode_id.district.id;
    this.clientEditForm.controls.address.value.state_id = this.clientEditForm.controls.address.value.pincode_id.state.id;
  ...
  pincodeeditdata(pin){
    ...
    //   disabled: true,
    // };
    this.clientEditForm.controls.address.patchValue({
      // pincode_id: pin,
      city_id: pin.city,
