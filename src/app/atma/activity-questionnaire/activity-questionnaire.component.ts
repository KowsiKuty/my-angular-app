...
export class ActivityQuestionnaireComponent implements OnInit {
  ...
  approver: any;
    ...
    // activity_flag: number; question_type: any; period: any;
    ...
    // remarks: string; type_status: any; vendor_id: any; Activity: number; answers: any[]; id: any;
    // // "dept_id":value?.dept_id,
    // dept_id: any; vendor_code: string; description: any; msg: string; level: number; activity_id: number;
  ...
  getactivityleveluestion(value) {
    ...
    this.atmaService.evaluateactivitysubmit(value).subscribe(
      result => {
        ...
        this.questiondescriptionid=data[0].description_id  //bug id
        console.log("this.questiondescriptionid===>",this.questiondescriptionid)
        console.log("this.questiondata==>",this.questiondata)
        console.log("results==>",result)
        this.approver=data[0].type_data[0].mappinghtml.type_status.id  //bug id
        // this.getfunction()
      }
    )
  }
