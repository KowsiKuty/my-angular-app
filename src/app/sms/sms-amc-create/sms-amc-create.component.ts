...
@Component({
  selector: 'app-sms-amc-create',
  templateUrl: './sms-amc-create.component.html',
  styleUrls: ['./sms-amc-create.component.scss'],
  providers:[
...
export class SmsAmcCreateComponent implements OnInit {
  ...
  approvedata(){
    ...
    if(this.smscreateform.get('periodicmail').value ==undefined || this.smscreateform.get('periodicmail').value=="" || this.smscreateform.get('periodicmail').value ==''){
      this.toastr.error('Please Select The periodicmail');
      return false;
    }
