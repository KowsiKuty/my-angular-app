...
@Component({
  selector: 'app-newproofingmapping',
  templateUrl: './newproofingmapping.component.html',
  styleUrls: ['./newproofingmapping.component.scss'],
  providers: [
...
export class NewproofingmappingComponent implements OnInit {
  ...
  constructor(
    ...
    this.proofingmap = {
      ...
      params: "&proof_temp_id="+this.proof_temp_id,
      searchkey: "query",
