...
export class EcfService {
  ...
  public getecfstatus(): Observable<any> {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    let params: any = new HttpParams();
    return this.http.get<any>(ecfmodelurl + "ecfserv/get_status_ddl", { 'headers': headers, params })
  }
  ...
  public getapprover(approverkeyvalue): Observable<any> {
    ...
    let urlvalue = ecfmodelurl + 'prserv/search_employeelimit?commodityid=1&type=ECF&employee=' + approverkeyvalue;
  ...
  public getapproverscroll(approverkeyvalue, pageno): Observable<any> {
    ...
    let urlvalue = ecfmodelurl + 'prserv/search_employeelimit?commodityid=1&type=ECF&employee=' + approverkeyvalue + '&page=' + pageno;
  ...
  public ccbscreate(value,id): Observable<any> {
    this.reset();
    const getToken: any = localStorage.getItem('sessionData')
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(ecfmodelurl + 'ecfserv/create_ccbs/'+id, value, { 'headers': headers })
  }
  ...
  public getdd(sub_module_name): Observable<any> {
    this.reset();
    const getToken: any = localStorage.getItem('sessionData')
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(ecfmodelurl + 'ecfapserv/dd?submodule='+sub_module_name, { 'headers': headers })
  }
  ...
  public downloadfile(id:any) {
    ...
    public getpaymentstatus(no:any): Observable<any> {
      ...
      const headers = { 'Authorization': 'Token ' + token }
      let params: any = new HttpParams();
      return this.http.get<any>(ecfmodelurl + "apserv/get_crnoo/"+no, { 'headers': headers, params })
    }
    ...
    public GetbranchgstnumberGSTtype(id): Observable<any> {
      this.reset();
      const getToken: any = localStorage.getItem('sessionData')
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      ...
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(ecfmodelurl + 'ecfserv/gsttypee/' +id , { 'headers': headers })
    }
    ...
    // 
  public getempModuleRole(data): Observable<any> {
    this.reset();
    const getToken: any = localStorage.getItem('sessionData')
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(ecfmodelurl + 'usrserv/employee_modulerole', data,{ 'headers': headers })
  }
