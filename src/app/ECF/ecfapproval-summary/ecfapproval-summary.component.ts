...
export class EcfapprovalSummaryComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private ecfservice: EcfService, private shareservice: ShareService,
    ...
    private datepipe: DatePipe, private commonService: SharedService) { }

    ngOnInit(): void {
    this.routeData = this.commonService.commonsummary.value 
  ...
  getapprovalsummary() {
    if(this.RoutingECFValue==1){
      ...
      this.approvalList = this.newDataRouting
    }
    else{
