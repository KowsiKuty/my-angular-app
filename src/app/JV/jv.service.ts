...
export class JvService {
  ...
  public getbs(bskeyvalue) {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(jvmodelurl + 'usrserv/searchbusinesssegment?query=' + bskeyvalue, { 'headers': headers })
  ...
  public getbsscroll(bskeyvalue, pageno): Observable<any> {
    ...
    let urlvalue = jvmodelurl + 'usrserv/searchbusinesssegment?query=' + bskeyvalue + '&page=' + pageno;
  ...
  public getcc(bsid, cckeyvalue) {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(jvmodelurl + 'usrserv/searchbs_cc?bs_id=' + bsid + '&query=' + cckeyvalue, { 'headers': headers })
  }
  ...
  public getccscroll(bsid, cckeyvalue, pageno): Observable<any> {
    ...
    let urlvalue = jvmodelurl + 'usrserv/searchbs_cc?bs_id=' + bsid + '&query=' + cckeyvalue + '&page=' + pageno;
  ...
  public crnosearchnew(data: any): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(jvmodelurl + "jvserv/search_crno", data, { 'headers': headers })
  }
   public crnosearch(crno: any): Observable<any> {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(jvmodelurl + "ecfapserv/get_approved_apcrno/"+crno, { 'headers': headers })
  }
  ...
  public getentrydetail(crno:any,pageno): Observable<any> {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    let params: any = new HttpParams();
    return this.http.get<any>(jvmodelurl + "entryserv/fetch_commonentrydetails/"+crno+'?page='+pageno, { 'headers': headers, params })
  ...
  public fileView(id) {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    window.open(jvmodelurl + 'jvserv/jvfile/' +id+"?token="+token, '_blank');
  }
  ...
  public jvsummarySearch(download,data:any,pageno): Observable<any> {
    ...
    const headers = { 'Authorization': 'Token ' + token } 
    if(download === true){
      return this.http.post<any>(jvmodelurl + "jvserv/jventrysearch?page="+pageno + "&download=1",data, { 'headers': headers , responseType: 'blob' as 'json'})
    }
    else{
      return this.http.post<any>(jvmodelurl + "jvserv/jventrysearch?page="+pageno, data, { 'headers': headers })
    }

  }

  public jvapprovalsummarySearch(download,data:any,pageno): Observable<any> {
    ...
    const headers = { 'Authorization': 'Token ' + token } 
    if(download === true){
    return this.http.post<any>(jvmodelurl + "jvserv/jventrysearch?page="+pageno+'&approval=true' +"&download=1", data, { 'headers': headers , responseType: 'blob' as 'json'})
    }
    else{
      return this.http.post<any>(jvmodelurl + "jvserv/jventrysearch?page="+pageno+'&approval=true', data, { 'headers': headers })
    }
  ...
  public rectifyentrysearch(crno):Observable<any>{
    ...
    let token = tokenValue?.token;
    const headers = {'Authorization':'Token '+token};
    return this.http.get<any>(jvmodelurl+"entryserv/get_ecf_entry/"+crno,{'headers':headers})
  }

  public TAEntrysearch(crno):Observable<any>{
    this.reset();
    const getToken = localStorage.getItem('sessionData');
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token;
    const headers ={ 'Authorization':'Token '+token };
    return this.http.get<any>(jvmodelurl+"ecfapserv/get_approved_tacrno/"+crno,{'headers':headers})
  }
  ...
  public getreportjvdata(data:any):Observable<any>{
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(jvmodelurl + "jvserv/jvjw_report?flag=JV", data, { 'headers': headers, responseType: 'blob' as 'json' })
  }
  ...
  public jvreturn(data){
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(jvmodelurl + "jvserv/jventryreturn", data, { 'headers': headers })
