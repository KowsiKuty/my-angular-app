...
@NgModule({
  declarations: [DssSummaryComponent, DssReportComponent, DssMasterComponent,SubGroupsComponent, SourceComponent, HeadGroupsComponent, GlSubgroupComponent, DssExceptionComponent, DssActiveComponent],
  imports: [
    ReactiveFormsModule,
    CommonModule,
    DssRoutingModule,
