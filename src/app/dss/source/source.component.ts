 ...
 sourcenewrowAdd(){
  ...
  for(let valsource of form.value){
    ...
    if(valsource.isEditable==false){
      ...
      this.source_summarylength=true;
...
@ViewChild(MatAutocompleteTrigger) autocompleteTrigger: MatAutocompleteTrigger;
 ...
 source__summary_clear(){
  this.source.reset('')
  this.source__summary_search(this.source.value)
 }
 source__summary_search(sourceval,pageNumber=1, pageSize=10){
  console.log("source summary search  values:", sourceval)
   let source
   let source_code
   console.log(source)
if(sourceval==null || sourceval==undefined || sourceval==''){
  ...
  source_code=sourceval.code
   ...
   this.SpinnerService.hide()
     ...
     if (this.source_summary.length > 0) {
      ...
      this.source_summarylength=false;
       console.log("val1")
       this.dsssource = this.formBuilder.group({
        newsource: this.formBuilder.array([]) 
      });
 ...
 deletesource(dssdelete,i){
  console.log("Delete source:", dssdelete)
...
EditSource(sourceedit, i) {
  console.log("Edit source value:", sourceedit)
...
savesource(source,i){
  console.log("Save source value:", source)
 ...
 editview_source(sourcesummary){
  console.log("Editview source:", sourcesummary)
