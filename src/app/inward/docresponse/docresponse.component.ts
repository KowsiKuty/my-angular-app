...
@Component({
  selector: 'app-docresponse',
  templateUrl: './docresponse.component.html',
  styleUrls: ['./docresponse.component.scss']
})
export class DocresponseComponent implements OnInit {
  [x: string]: any;
  ChannelList: any
  InwardMenuList: any
  urls: string;
  ...
  ngOnInit(): void {
      ...
      params => {
        ...
        if (params['Docnum']) {
          ...
          this.documentnum = params['Docnum'];
   ...
   this.InwardDocResponsesummarySearchForm.get('courier_id').valueChanges
    ...
    this.InwardDocResponsesummarySearchForm.get('branch_id').valueChanges
      ...
      if(this.documentnum != '' && this.documentnum != undefined && this.documentnum != null){
        this.InwardDocResponsesummarySearchForm.patchValue({
          docnumber: this.documentnum
  ...
  //   if (stringValue[3] === "png" || stringValue[3] === "jpeg" || stringValue[3] === "jpg") {
  ...
  //       });
  //   }
  // if (stringValue[1] === "csv" || stringValue[1] === "ods" || stringValue[1] === "xlsx" || stringValue[1] === "txt" || stringValue[1] === "doc" || stringValue[1]=== "docx") {
  //     this.showimageHeaderPreview = false
  //     this.showimageHeaderPreviewPDF = false
  //     this.showtxt =false
  //         this.showdoc=false
...
//   getFileApiComments(dataSetForComments) {
...
//     this.dataService.getemployeeFKddBasedOnDept(dataToSearch, refDeptid, this.currentpageemp)
//       .subscribe((results: any[]) => {
//         let datas = results["data"];
...
//           return false
//         }
//         else if (val.todate !== '' && val.fromdate === '') {
//           this.notification.showError("Please enter 'From date' ")
//           return false
//         }
...
if( branchid !=null || branchid !='' || branchid != undefined ){
  ...
  this.InwardDocAssignSummarySearchForm.value.branch_id = branchid?.id
    ...
    if(searchInwardDocAssign.assignedto==1 || searchInwardDocAssign.assignedto==2 ||branchid !=''){
      this.ischanged=true
    }
    else{
  ...
  submitAssign(data, index) {
    ...
    if (data.assigndept_id == '' || data.assigndept_id == null || data.assigndept_id == undefined) {
  ...
  savedataBulkDocAssign() {
    ...
    let dataToSubmit: any = {
      ...
      assigndept_id: dataForm.assigndept_id,
