...
@Component({
  selector: 'app-jwsummary-view',
  templateUrl: './jwsummary-view.component.html',
  styleUrls: ['./jwsummary-view.component.scss']
})
export class JwsummaryViewComponent implements OnInit {
