...
@Component({
  selector: 'app-newbrsform',
  templateUrl: './newbrsform.component.html',
  styleUrls: ['./newbrsform.component.scss']
})
export class NewbrsformComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private notification: NotificationService, private brsService: BrsApiServiceService,
    private router: Router, config: NgbCarouselConfig, private spinner: NgxSpinnerService,) {}
