...
@Component({
  selector: 'app-rent-term-form',
  templateUrl: './rent-term-form.component.html',
  styleUrls: ['./rent-term-form.component.scss'],
  providers: [
...
export class RentTermFormComponent implements OnInit {
      ...
      this.remsService.rentTermFormCreate(this.rentTermForm.value, '')
        .subscribe(result => {
          ...
          if (result.code === "INVALID_DATA" && result.description === "Invalid Data or DB Constraint") {
            ...
            this.router.navigate(['/rems/scheduleview'], { queryParams: { status: "rent_term" }, skipLocationChange: true });
          }
