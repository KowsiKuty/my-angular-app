...
// const Url = imp.env.apiURLS
const Url = imp.env.apiURL
...
export class ApicallserviceService {
  ...
  constructor(private http: HttpClient, private idle: Idle,private dataservice:DataService) { 
    // let logdata = {"username":"EMP001","password":"1234","entity_id":1}
    // this.dataservice.crmlogin(logdata).subscribe(result=>{
  ...
  public ApiCall(...queryCall): Observable<any> {
    ...
    if (arguments[0] == 'getFile') {
      arrangeAPI = arguments[0]+arguments[1] 
