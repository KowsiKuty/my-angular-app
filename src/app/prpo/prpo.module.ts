...
import { BranchrequestMakerComponent } from './branchrequest-maker/branchrequest-maker.component';
import { BranchrequestApproverComponent } from './branchrequest-approver/branchrequest-approver.component';
import { PrBranchMakerComponent } from './pr-branch-maker/pr-branch-maker.component';
import { NgxSummernoteModule } from 'ngx-summernote';
import { PoCreateComponent } from './po-create/po-create.component';
import { PrQuotationComponent } from './pr-quotation/pr-quotation.component';
import { PrBranchQuotationComponent } from './pr-branch-quotation/pr-branch-quotation.component';
import { PrBatchComponent } from './pr-batch/pr-batch.component';
import { InfiniteScrollModule } from 'ngx-infinite-scroll';
import { GrnupdateComponent } from './grnupdate/grnupdate.component';
  ...
  declarations: [CommodityComponent, PrpomasterComponent, PARMakeDetailsComponent,
    ...
    //  RcnapproverComponent, RcnapproversummaryComponent, PrpoTabsRcnComponent, 
     PrMakerComponent, PoModificationComponent, RentConfirmationNoteComponent,
      ...
      BranchrequestMakerComponent,
      BranchrequestApproverComponent,
      PrBranchMakerComponent,
      PoCreateComponent,
      PrQuotationComponent,
      PrBranchQuotationComponent,
      PrBatchComponent,
      GrnupdateComponent],

  imports: [
    PRPORoutingModule,
    PdfViewerModule, SharedModule, MaterialModule,NgxPaginationModule, NgxSummernoteModule,InfiniteScrollModule
  ],
   providers: [
