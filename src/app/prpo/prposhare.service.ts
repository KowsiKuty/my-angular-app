...
public brsummary               = new BehaviorSubject<any>('');
public pcadata                      = new BehaviorSubject<any>('');
public rcnsummary              = new BehaviorSubject<any>('');
public rcnrelease              = new BehaviorSubject<string>('');
public pr                      = new BehaviorSubject<any>(null);   //7420
public summaryfile             = new BehaviorSubject<string>('');
public prapproverblk           = new BehaviorSubject<string>('');    //7421
public backtoSummaryValue      = new BehaviorSubject<any>('');
