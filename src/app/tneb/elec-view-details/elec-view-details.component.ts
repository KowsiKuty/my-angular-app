...
@Component({
  selector: 'app-elec-view-details',
  templateUrl: './elec-view-details.component.html',
  styleUrls: ['./elec-view-details.component.scss']
})
export class ElecViewDetailsComponent implements OnInit {
