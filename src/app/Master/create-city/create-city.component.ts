...
export class CreateCityComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder,private masterService:masterService,private notofication:NotificationService,private spinner:NgxSpinnerService) { }
  ...
  addstate(){
    ...
    this.stateform.get('newstate').reset('');
  }
  adddistrict(){
    this.citysenb=! this.citysenb;
    this.citysenbbtn=!this.citysenbbtn;
    this.citysenbcan=!this.citysenbcan;
    this.districtform.get('newdistrict').reset('');
  }
  addcity(){
    this.cityssenb=!this.cityssenb;
    this.cityssenbbtn=!this.cityssenbbtn;
    this.cityssenbcan=!this.cityssenbcan;
    this.cityform.get('newcityname').reset('');
    this.cityform.get('cpincode').reset('');
  }
  createstate(){
    console.log(this.stateform.value);
    if(this.stateform.get('country').value.id==undefined || this.stateform.get('country').value=="" || this.stateform.get('country').value=='' || this.stateform.get('country').value==''){
      this.notofication.showError('Please Select The Country ');
      return false;
    }
    if(this.stateform.get('newstate').value.toString().trim()==undefined || this.stateform.get('newstate').value=="" || this.stateform.get('newstate').value=='' || this.stateform.get('newstate').value==''){
      this.notofication.showError('Please Enter The New State');
      return false;
    }
    ...
    this.masterService.createStateForm(data).subscribe(res=>{
      this.spinner.hide();
       if (res.status === "success"){
         this.notofication.showSuccess(res.message);
          // this.onSubmit.emit();
          this.cityenb=!this.cityenb;
         this.cityenbbtn=!this.cityenbbtn;
          this.cityenbcan=!this.cityenbcan;
        ...
        this.notofication.showWarning(res.description)
  ...
  createdistrict(){
    ...
    if(this.districtform.get('statename').value.id==undefined || this.districtform.get('statename').value=='' || this.districtform.get('statename').value==undefined || this.districtform.get('statename').value==null){
      this.notofication.showError('Please Select The State Name');
      return false;
    }
  ...
  getcitydata(){
    ...
    if(this.cityform.get('cdistrict').value.id=="" || this.cityform.get('cdistrict').value=='' || this.cityform.get('cdistrict').value==undefined || this.cityform.get('cdistrict').value==null){
      this.notofication.showError('Please Select The District Name');
      return false;
    }
    ...
    if(this.cityform.get('cpincode').value.toString().trim()=="" || this.cityform.get('cpincode').value.toString().trim()=='' || this.cityform.get('cpincode').value==undefined || this.cityform.get('cpincode').value==null){
      this.notofication.showError('Please Enter The Pincode');
      return false;
    }    let data:any={'name':this.cityform.get('newcityname').value.toString().trim(),'state_id':this.cityform.get('cstate').value.id,'no':this.cityform.get('cpincode').value,'district':this.cityform.get('cdistrict').value.id};
    console.log(data)
    this.spinner.show();
