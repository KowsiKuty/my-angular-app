...
export class EmpbranchCreateComponent implements OnInit {
  ...
  minLength:number=10;
  maxLength:number=10;
  // file_uploaddata:Array<any>=[];
  // file_processApi:any=new FormData();
  ...
  ngOnInit(): void {
    this.createemployss=this.fb.group({
      ...
      'condob':new FormControl('',Validators.required),
      'conwedday':new FormControl(''),
      'tanno':new FormControl('',[Validators.maxLength(10)]),
      'glno':new FormControl(''),
      'stdno':new FormControl('',[Validators.minLength(2),Validators.maxLength(10),Validators.pattern('[1-9][0-9]*')]),
    ...
    this.createemployss.get('incharge').valueChanges
      ...
      // this.createemployss.get('approverid').valueChanges
      // .pipe(
      //   debounceTime(100),
      //   distinctUntilChanged(),
      //   tap(() => {
    ...
    this.createemployss.get('condesignation').valueChanges
    .pipe(
      debounceTime(100),
      distinctUntilChanged(),
      tap(() => {
  ...
  getincharge(){
    this.masterservice.getemployeeFKdd('',1).subscribe(results=>{
        this.employeeList = results["data"];
        let datapagination:any= results["pagination"];   
  ...
  employeecreatedata(){
    ...
    if(this.createemployss.get('code').value.trim()=='' || this.createemployss.get('code').value==null || this.createemployss.get('code').value==undefined){
      this.notification.showWarning('Please Enter The Valid Branch Code');
      return false;
    }
    if(this.createemployss.get('name').value.trim()=='' || this.createemployss.get('name').value==null || this.createemployss.get('name').value==undefined){
      this.notification.showWarning('Please Enter The  Valid Branch Name');
      return false;
    }
    ...
    if(this.createemployss.get('branch').value.id==null || this.createemployss.get('branch').value.id==null || this.createemployss.get('branch').value==undefined || this.createemployss.get('branch').value==''){
      this.notification.showWarning('Please Select The Control Branch  Name');
      return false;
    }
    ...
    if(this.createemployss.get('line1').value==null || this.createemployss.get('line1').value==null || this.createemployss.get('line1').value==undefined || this.createemployss.get('line1').value==''){
      this.notification.showWarning('Please Enter The Line1');
      return false;
    }
    ...
    if(this.createemployss.get('pincode').value.id==null || this.createemployss.get('pincode').value.id==undefined || this.createemployss.get('pincode').value==undefined || this.createemployss.get('pincode').value==''){
      this.notification.showWarning('Please Select The Pincode');
      return false;
    }
    if(this.createemployss.get('city').value.id==null || this.createemployss.get('city').value.id==undefined || this.createemployss.get('city').value==undefined || this.createemployss.get('city').value==''){
      this.notification.showWarning('Please Select  The City');
      return false;
    }
    if(this.createemployss.get('district').value.id==null || this.createemployss.get('district').value.id==undefined || this.createemployss.get('district').value==undefined || this.createemployss.get('district').value==''){
      this.notification.showWarning('Please Select The District');
      return false;
    }
    if(this.createemployss.get('state').value.id==null || this.createemployss.get('state').value.id==undefined || this.createemployss.get('state').value==undefined || this.createemployss.get('state').value==''){
      this.notification.showWarning('Please Select The State');
      return false;
    }
    if(this.createemployss.get('contacttype').value==null || this.createemployss.get('contacttype').value==undefined || this.createemployss.get('contacttype').value=="" || this.createemployss.get('contacttype').value==''){
      this.notification.showWarning('Please Enter The ContactType');
      return false;
    }
    if(this.createemployss.get('landline1').value.length !=10 || this.createemployss.get('landline1').value==undefined || this.createemployss.get('landline1').value=="" || this.createemployss.get('landline1').value==''){
      this.notification.showWarning('Please Enter The landline1');
      return false;
    }
    ...
    if(this.createemployss.get('contactnumber').value.length !=10 || this.createemployss.get('contactnumber').value==undefined || this.createemployss.get('contactnumber').value=="" || this.createemployss.get('contactnumber').value==''){
      this.notification.showWarning('Please Enter The Contactnumber');
      return false;
    }
    ...
    if(this.createemployss.get('conemailid').valid==false || this.createemployss.get('conemailid').value==undefined || this.createemployss.get('conemailid').value=="" || this.createemployss.get('conemailid').value==''){
      this.notification.showWarning('Please Enter The Contact mailId');
      return false;
    }
    if(this.createemployss.get('condob').value==null || this.createemployss.get('condob').value==undefined || this.createemployss.get('condob').value=="" || this.createemployss.get('condob').value==''){
      this.notification.showWarning('Please Enter The Contact DOB');
      return false;
    }
    ...
    //   return false;
    // }
    // if(this.createemployss.get('approverid').value.id==undefined ||  this.createemployss.get('approverid').value==null || this.createemployss.get('approverid').value==undefined || this.createemployss.get('approverid').value=="" || this.createemployss.get('approverid').value==''){
    //   this.notification.showWarning('Please Select The Valid Approver');
    //   return false;
    // }
    console.log(this.createemployss.value);
    let Gender:any={'Male':1,"Female":2,"TransGender":3};
    let contactType={'EMPLOYEE':5,'GROUP123':10,'INDIVIDUAL':1};
  // this.file_processApi.delete('file');
  // this.file_processApi.delete('data');
  // for(let i=0;i<this.file_uploaddata.length;i++){
  //   this.file_processApi.append('file',this.file_uploaddata[i].file);
  // }
   let data:any={
      ...
      "incharge":this.createemployss.get('incharge').value.full_name,
        ...
        "wedding_date":this.datepipe.transform(this.createemployss.get('conwedday').value,'yyyy-MM-dd')
            ...
            "control_office_branch":this.createemployss.get('branch').value.code,
        ...
        // "approverid":this.createemployss.get('approverid').value.id
  
   } ;
  // this.file_processApi.append('data',JSON.stringify(data)); 
  this.spinner.show();
    this.masterservice.getemployeebranch(data).subscribe(datas=>{
      ...
      if(datas['status']=='success'){
      ...
      else if(datas.code==='Duplicate Name'){
        this.notification.showWarning(datas.description);
      }
      else if(datas.code ==='INVALID_DATA'){
        this.notification.showWarning(datas.description);
      }
      else if(datas.code==='UNEXPECTED_ERROR' && datas.description==='NOT ALLOWED TO CREATE EMPLOYEE CONTACT'){
        this.notification.showError("NOT ALLOWED TO CREATE EMPLOYEE BRANCH IN 'PROD' ENVIRONMENT")
      }
      else if(datas.code==='UNEXPECTED_ERROR' && datas.description==='NOT ALLOWED TO CREATE EMPLOYEE ADDRESS'){
        this.notification.showError("NOT ALLOWED TO CREATE EMPLOYEE BRANCH IN 'PROD' ENVIRONMENT")
      }
      else if(datas.code==='UNEXPECTED_ERROR' && datas.description==='NOT ALLOWED TO CREATE EMPLOYEE BRANCH'){
        this.notification.showError("NOT ALLOWED TO CREATE EMPLOYEE BRANCH IN 'PROD' ENVIRONMENT")
      }
        ...
        this.notification.showWarning(datas['code']);
        this.notification.showWarning(datas['description']);
      }
      this.spinner.hide();
  ...
  //       this.file_uploaddata.push({"name":event.target.files[i].name,"file":event.target.files[i]});
  //     }
