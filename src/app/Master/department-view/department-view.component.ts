...
export class DepartmentViewComponent implements OnInit {
  ...
  getDepartmentName(id) {
    this.dataService.get_Department(id)
      .subscribe((results: any[]) => {
        ...
        this.departmentControl.patchValue(results)
  ...
  public displayFromDept(fromdepartment?: Department): string | undefined {
    // let branchname =  fromdepartment?.branch?.name == null ? "" : fromdepartment?.branch?.name
    // let deptname = fromdepartment?.name == null ? "" : "(" +  fromdepartment?.name + ")"
    // let concat = branchname  + deptname  
    // console.log("branch name , dept name concat", branchname , deptname, concat)
    return fromdepartment ? fromdepartment.view_name : undefined 
    // return fromdepartment ? fromdepartment.name : undefined;
  }


  CallByDepartment(data){ 
    this.getDepartmentName(data?.id) 
    this.getDepartmentToEmployeeList(data?.id)
