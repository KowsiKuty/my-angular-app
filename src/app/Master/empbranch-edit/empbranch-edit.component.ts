...
export class EmpbranchEditComponent implements OnInit {
  ...
  contactTyped={5:'EMPLOYEE',10:'GROUP123',1:'INDIVIDUAL'};
  reg:any=new RegExp('^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$');

  constructor(private shareservice:ShareService,private spinner:NgxSpinnerService,private datepipe:DatePipe,private fb:FormBuilder,
    private masterservice:masterService,private notification:NotificationService,private toastService:ToastrService) { }
  ...
  dataid:any;
  empbranchedit(){
       this.dataid=this.shareservice.empbrnachedit.value;
       this.masterservice.getempbrancheditdata(this.dataid.id).subscribe(datas=>{
    // let dts:any=d;
    // this.file_uploaddata=datas['file_data'];
       this.createemployss.patchValue({
       'code':datas['code'],
       'name':datas['name'],
       'entity':datas['entity'],
       'tanno':datas['tanno']?datas['tanno']:'',
       'glno':datas['glno']?datas['glno']:'',
       'stdno':datas['stdno']?datas['stdno']:'',
       'incharge':{'full_name':datas['incharge']},
       'gstin':datas['gstin'],
       'branch':{'id':datas['control_office_branch']['id'],'name':datas['control_office_branch']['name'],'code':datas['control_office_branch']['code']},
       'line1':datas['address']['line1'],
       'line2':datas['address']['line2'],
       'line3':datas['address']['line3'],
       'pincode':{'id':datas['address']['pincode']['id'],'no':datas['address']['pincode']['no']},
       'city':{'id':datas['address']['city']['id'],'name':datas['address']['city']['city_name']},
       'district':{'id':datas['address']['district']['id'],'name':datas['address']['district']['name']},
       'state':{'id':datas['address']['state']['id'],'name':datas['address']['state']['name']},
       'contacttype':this.contactTyped[datas['contact']['type_id']],
       'personname':datas['contact']['name'],
       'condesignation':{'id':datas['contact']['designation']['id'],'name':datas['contact']['designation']['name']},
       'landline1':datas['contact']['landline'],
       'landline2':datas['contact']['landline2'],
       'contactnumber':datas['contact']['contactnumber'],
       'contactnumber2':datas['contact']['contactnumber2'],
       'conemailid':datas['contact']['email'],
       'condob':datas['contact']['dob'],
       'conwedday':datas['contact']['wedding_date'],
       'Assetcodeprimary':datas['assetcodeprimary'],
       'approverid':datas['approvename']
