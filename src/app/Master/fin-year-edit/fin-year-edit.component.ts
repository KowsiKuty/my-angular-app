...
@Component({
  selector: 'app-fin-year-edit',
  templateUrl: './fin-year-edit.component.html',
  styleUrls: ['./fin-year-edit.component.scss']
})
export class FinYearEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let d:any=this.shareservice.finedit.value;
    this.id=d.id;
