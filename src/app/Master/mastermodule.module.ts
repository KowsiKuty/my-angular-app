...
import { EmccontactsAddComponent } from './emccontacts-add/emccontacts-add.component';
...
@NgModule({
  declarations: [
    ...
    PmdBranchEditComponent, ExpenceGrpCreateComponent, ExpenceGrpEditComponent, ExpenceEditComponent, ExpenceCreateComponent, EntityCreateComponent, FinYearCreateComponent, FinYearEditComponent, FinquaterYearCreateComponent, FinquaterYearEditComponent,MailTemplateComponent,MailTemplateCreateComponent,MailTemplateEditComponent, BranchBankAddComponent, EmpbranchviewComponent, EmpbranchCreateComponent, EmpbranchEditComponent, RoleCreateComponent, EmccontactsAddComponent
