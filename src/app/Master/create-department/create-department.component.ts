  ...
  submitForm() {
    ...
    this.memoService.creatMemoForm(this.createFormate())
      .subscribe(res => {
        ...
        else if(code ==="UNEXPECTED_ERROR" && res.description==="NOT ALLOWED TO CREATE DEPARTMENT"){
          this.notification.showError("NOT ALLOWED TO DEPARTMENT  IN 'PROD' ENVIRONMENT")
        }
        else if(code ==="Duplicate Name"){
          this.notification.showError(res.description);
        }
