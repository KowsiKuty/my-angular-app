...
export class MemoService {
    ...
    public getemplistindividual(cckeyvalue, pageno): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        ...
        let urlvalue = this.mem_URL + '/vom_dropsearch?query=' + cckeyvalue + '&page=' + pageno;
        return this.http.get(urlvalue, {
            headers: new HttpHeaders()
                .set('Authorization', 'Token ' + token)
        }
    ...
    public branchactive(data): Observable<any> {
        ...
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        let urlvalue = this.mem_URL + '/other_notes_inactive/' + data
        return this.http.get(urlvalue, {
            headers: new HttpHeaders()
                .set('Authorization', 'Token ' + token)
        }
    ...
    findMemoList1(
        ...
        if (urlname === 'search') {
            const body = filter;
            return this.http.post(this.mem_URL + '/' + urlname, body, {
                params,
                // params: new HttpParams()
                //     .set('page', pageNumber.toString()),
                // params: new HttpParams()
    ...
    public get_priority(): Observable<any> {
      ...
      public get_app_dash(type,startdate,enddate,viewemp,dtype): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token;
        const headers = { 'Authorization': 'Token ' + token }
        // +'&d_type='+dtype
        let url = memoUrl + 'memserv/approverdasboard?mtype='+type+'&start_date='+startdate+'&enddate_date='+enddate+'&view_emp='+viewemp;
        return this.http.get<any>(url, { 'headers': headers })
    }
      public get_app_dash_down(type,startdate,enddate,viewemp,dtype): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token;
        const headers = { 'Authorization': 'Token ' + token }
        // +'&d_type='+dtype
        let url = memoUrl + 'memserv/overall_countsreport?mtype='+type+'&start_date='+startdate+'&enddate_date='+enddate+
        '&view_emp='+viewemp+'&d_type='+dtype;
    ...
    public getsummarylists(page,pagesize): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.get<any>(memoUrl + "memserv/other_notes_empsummmry?page="+ page, { 'headers': headers })
    }
    public getnewsearchsummarylists(emp,assign,page,pagesize): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.get<any>(memoUrl + "memserv/other_notes_empsummmry?emp_from="+emp+"&assign_to="+assign +"&page="+page, { 'headers': headers })
    }
    ...
    public SingleEmployeeActiveInactive(data): Observable<any> {
        ...
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.post<any>(memoUrl + 'usrserv/emp_activate', submitValue, { 'headers': headers })
    }

    public staffwise_deptwise_tat_ageing(reportjson: any): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const body = JSON.stringify(reportjson)
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.post<any>(this.mem_URL + '/staffwise_deptwise_tat_ageing', body, { 'headers': headers, observe: 'response', responseType: 'blob' as 'json' })
        // return this.http.post<any>(remsUrl + "reportserv/querydata_download",data, { 'headers': headers ,responseType:'blob' as 'json'})
    }
    public TATDownl(reportjson: any): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const body = JSON.stringify(reportjson)
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.post<any>(this.mem_URL + '/tat_ageing_new', body, { 'headers': headers, observe: 'response', responseType: 'blob' as 'json' })
        // return this.http.post<any>(remsUrl + "reportserv/querydata_download",data, { 'headers': headers ,responseType:'blob' as 'json'})
    }
    public AgingDownl(reportjson: any): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const body = JSON.stringify(reportjson)
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.post<any>(this.mem_URL + '/staffwise_deptwise_ageing', body, { 'headers': headers, observe: 'response', responseType: 'blob' as 'json' })
        // return this.http.post<any>(remsUrl + "reportserv/querydata_download",data, { 'headers': headers ,responseType:'blob' as 'json'})
    }
    public commentdraftClick(comment: any, id: any, commenttype: any): Observable<any> {
        this.reset();
        let token = '';
        const getToken = localStorage.getItem("sessionData");
        if (getToken) {
        ...
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.post<any>(memoUrl + "memserv/comment_draft", bodyvalue, { 'headers': headers })
    }
    public get_Comment(memo_id: any, type: any): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const headers = { 'Authorization': 'Token ' + token }
        let url = this.mem_URL + '/comment_draft' + '?memo_id=' + memo_id + '&type=' + type;
        return this.http.get<any>(url, { 'headers': headers })
    }
    public memowise_tat_ageing(reportjson: any): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        const body = JSON.stringify(reportjson)
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.post<any>(this.mem_URL + '/memowise_tat_ageing', body, { 'headers': headers, observe: 'response', responseType: 'blob' as 'json' })
        // return this.http.post<any>(remsUrl + "reportserv/querydata_download",data, { 'headers': headers ,responseType:'blob' as 'json'})
    }
    public submitattendance(content: any): Observable<any> {
        this.reset();
        let token = '';
        const getToken = localStorage.getItem("sessionData");
        if (getToken) {
        ...
        const headers = { 'Authorization': 'Token ' + token }
        let url = memoUrl + "memserv/create_leave_history"
        return this.http.post<any>(url, content, { 'headers': headers })
    }
    public submitviewrights(content: any): Observable<any> {
        this.reset();
        let token = '';
        const getToken = localStorage.getItem("sessionData");
        if (getToken) {
        ...
        const headers = { 'Authorization': 'Token ' + token }
        let url = memoUrl + "memserv/vom_mapping"
        return this.http.post<any>(url, content, { 'headers': headers })
    }
    public deleteattendance(content: any): Observable<any> {
        this.reset();
        let token = '';
        const getToken = localStorage.getItem("sessionData");
        if (getToken) {
        ...
        const headers = { 'Authorization': 'Token ' + token }
        let url = memoUrl + "memserv/leave_inactive"
        return this.http.post<any>(url, content, { 'headers': headers })
    }
    public download_schedular(reportjson: any): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        // const body = JSON.stringify(reportjson)
        const headers = { 'Authorization': 'Token ' + token }
        return this.http.get<any>(this.mem_URL + '/download_report_document/' + reportjson, { 'headers': headers, observe: 'response', responseType: 'blob' as 'json' })
        // return this.http.post<any>(remsUrl + "reportserv/querydata_download",data, { 'headers': headers ,responseType:'blob' as 'json'})
    }

    public getMemoSummary(): Observable<any> {
        this.reset();
        const getToken = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token;
        const headers = { 'Authorization': 'Token ' + token }
        let url = memoUrl + 'memserv/pendingdashboardsummary';
        return this.http.get<any>(url, { 'headers': headers })
    }
}