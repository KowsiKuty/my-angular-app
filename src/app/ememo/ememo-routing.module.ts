...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'memoreport', component: MemoreportComponent, canActivate: [CanActivateGuardService] },
      { path: 'memoView', component: MemoViewComponent, canActivate: [CanActivateGuardService] },
      { path: 'memoskip', component: MemoskipComponent, canActivate: [CanActivateGuardService] },
      ...
      {path:'ViewrightscreateComponent',component:ViewrightscreateComponent, canActivate: [CanActivateGuardService]}
    ]
  }
];
