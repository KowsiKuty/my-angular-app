...
export class QueryscreenComponent implements OnInit {
  ...
  tabledata:Array<any>=[];
  constructor(private fb:FormBuilder,private reportservice:ReportserviceService,private spinner:NgxSpinnerService,private notifications:NotificationService) { }
  ...
  ngOnInit(): void {
    ...
    // this.reportservice.gettablelist(this.schemavalue,'').subscribe(data=>{
  ...
  gettablelistdata(){
    ...
    this.queryForm.get('table').valueChanges.pipe(
      tap(()=>{
        this.isLoading=true;
      }),
      switchMap((value:any)=>this.reportservice.gettablelist(this.schemavalue,value).pipe(
        finalize(()=>{
          this.isLoading=false;
        })
      ))
  ...
  getcolumnslistdata(){
    ...
    this.queryForm.get('columns').valueChanges.pipe(
      tap(()=>{
        this.isLoading=true;
      }),
      switchMap((value:any)=>this.reportservice.getcolumnList(this.schemavalue,this.tablevalue,value).pipe(
        finalize(()=>{
          this.isLoading=false;
        })
      ))
  ...
  getcolumnslistdata_con(){
    ...
    this.queryForm.get('columnwhere').valueChanges.pipe(
      tap(()=>{
        this.isLoading=true;
      }),
      switchMap((value:any)=>this.reportservice.getcolumnList(this.schemavalue,this.tablevalue,value).pipe(
      ...
      this.conwherecolumnList=data['data'];
    });
  ...
  queryexecutedata(){
    ...
    //     this.notifications.showWarning(i+':Keyword Not Allowed');
    //     return false;
    //   };
    // };
  ...
  let data:any={
    ...
    this.spinner.show();
    this.reportservice.getquerydatadownload(data).subscribe(result=>{
      this.spinner.hide();
      let data=[];
      data.push(result);
      ...
      link.download='ExcelQueryData.xlsx';
      link.click();
    },(error)=>{
      this.spinner.hide();
  ...
  overallget(){
    ...
    let data_query='select * from '+this.queryForm.get('schema').value+'.'+this.queryForm.get('table').value;
    if(this.queryForm.get('columns').value !=undefined && this.queryForm.get('columns').value !='' && this.queryForm.get('columns').value !=null ){
      console.log(' where '+this.queryForm.get('columns').value);
      data_query=data_query+' where '+this.queryForm.get('columns').value;
    }
    if(this.queryForm.get('wherevalue').value !=undefined && this.queryForm.get('wherevalue').value !='' && this.queryForm.get('wherevalue').value !="" && this.queryForm.get('wherevalue').value !=null){
      console.log('="'+this.queryForm.get('wherevalue').value+'"');
      data_query=data_query+' ="'+this.queryForm.get('wherevalue').value+'"';
    }
    if(this.queryForm.get('wherevalues').value !=undefined && this.queryForm.get('wherevalues').value !='' && this.queryForm.get('wherevalues').value !=null && this.queryForm.get('wherevalues').value !=""){
      console.log(22)
      console.log(this.queryForm.get('wherevalues').value);
      console.log(this.queryForm.get('columnwhere').value);
      console.log(' '+this.queryForm.get('wherevalues').value+' '+this.queryForm.get('columnwhere').value);
      data_query=data_query+' '+this.queryForm.get('wherevalues').value+' '+this.queryForm.get('columnwhere').value;//wherevalues
    }
    if(this.queryForm.get('columnvalue').value !="" && this.queryForm.get('columnvalue').value !=undefined && this.queryForm.get('columnvalue').value !=null && this.queryForm.get('columnvalue').value !='None'){
      console.log(this.queryForm.get('columnvalue').value);
      console.log('="'+this.queryForm.get('columnvalue').value+'"');
      data_query=data_query+' ="'+this.queryForm.get('columnvalue').value+'"';
    }
    console.log('ff');
    console.log(data_query);
    console.log(this.queryForm.value);
    this.queryForm.get('selectquery').patchValue(data_query);
  }
}
