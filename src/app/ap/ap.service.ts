...
export class ApService {
  ...
  public delInvHdr(id): Observable<any> {
    ...
    return this.http.post<any>(apUrl + 'apserv/apinvoiceheader/' +id,{ 'headers': headers })
  }  
  ...
  public getPaymode(): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(apUrl + 'mstserv/paymode_search', { 'headers': headers })
  }
  ...
  public getbs(bskeyvalue) {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(apUrl + 'usrserv/searchbusinesssegment?query=' + bskeyvalue, { 'headers': headers })
  ...
  public getbsscroll(bskeyvalue, pageno): Observable<any> {
    ...
    let urlvalue = apUrl + 'usrserv/searchbusinesssegment?query=' + bskeyvalue + '&page=' + pageno;
  ...
  public getcc(bsid, cckeyvalue) {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(apUrl + 'usrserv/searchbs_cc?bs_id=' + bsid + '&query=' + cckeyvalue, { 'headers': headers })
  }
  ...
  public getccscroll(bsid, cckeyvalue, pageno): Observable<any> {
    ...
    let urlvalue = apUrl + 'usrserv/searchbs_cc?bs_id=' + bsid + '&query=' + cckeyvalue + '&page=' + pageno;
  ...
  //APPROVER SCROLL
    ...
    public getsupplierdet(id): Observable<any> {
      this.reset();
      const getToken: any = localStorage.getItem('sessionData')
      let tokenValue = JSON.parse(getToken);
      ...
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(apUrl + 'apserv/supplier_report/' + id, { 'headers': headers })
    }
